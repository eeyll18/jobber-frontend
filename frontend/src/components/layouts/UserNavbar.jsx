  ...
  return (
    <nav className="bg-white w-full px-4 md:px-6 py-3 flex items-center justify-between border-b border-gray-200 fixed top-0 left-0 z-50">
      ...
      <div className="hidden md:flex items-center space-x-1 lg:space-x-2 relative">
        <NavLink className={getNavLinkClass} to="/job-postings">
          Find Jobs
        </NavLink>
        <NavLink className={getNavLinkClass} to="/my-applications">
          My Applications
        </NavLink>
        ...
        {isProfileDropdownOpen && (
          <div
            ref={dropdownRef}
            className="absolute right-0 mt-2 top-full w-48 bg-white rounded-md shadow-lg py-1 ring-1 ring-black ring-opacity-5 z-50"
            role="menu"
